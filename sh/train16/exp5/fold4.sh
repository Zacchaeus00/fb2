#!/bin/bash
##nbroad train16-exp1 + random fold
#SBATCH --job-name=train16-exp5-fold4
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
--epochs 10 --batch_size 2 --lr 5e-6 --lr_head 1e-4 --seed -1 --fold 4 --exp 5 \
...
--warmup_ratio 0.1 --resize_embedding --random_fold
