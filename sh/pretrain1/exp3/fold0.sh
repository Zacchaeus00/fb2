#!/bin/bash
#SBATCH --job-name=pretrain1-exp3
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python -u pretrain1.py --ckpt /gpfsnyu/scratch/yw3642/hf-models/allenai_longformer-large-4096 \
--epochs 30 --batch_size 4 --lr 1e-5 --weight_decay 0 --seed -1 --max_len 2048 \
--exp 3 --mlm_prob 0.3 --gradient_checkpointing --resize_embedding
echo "FINISH"