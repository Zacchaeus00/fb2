#!/bin/bash
#SBATCH --job-name=pretrain1-exp1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python -u pretrain1.py --ckpt /gpfsnyu/scratch/yw3642/hf-models/microsoft_deberta-large \
--epochs 30 --batch_size 4 --lr 1e-5 --weight_decay 0 --seed -1 --max_len 1024 \
--exp 1 --mlm_prob 0.3 --gradient_checkpointing --resize_embedding
echo "FINISH"