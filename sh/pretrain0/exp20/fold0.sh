#!/bin/bash
#SBATCH --job-name=pretrain0-exp20
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python -u pretrain0.py --ckpt /gpfsnyu/scratch/yw3642/hf-models/microsoft_deberta-xlarge-mnli \
--epochs 35 --batch_size 2 --lr 5e-6 --weight_decay 0 --seed -1 --max_len 1024 \
--exp 20 --mlm_prob 0.3 --gradient_checkpointing
echo "FINISH"