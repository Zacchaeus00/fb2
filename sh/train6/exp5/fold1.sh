#!/bin/bash
#SBATCH --job-name=train6-exp5-fold1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
--epochs 10 --batch_size 2 --lr 1e-5 --seed -1 --fold 1 --exp 5 \
--use_pretrained /gpfsnyu/scratch/yw3642/fb2/ckpt/pretrain0/exp6/pretrained_model.pt \
--adv_lr 1 --adv_eps 0.0005 --adv_after_epoch 1 --patience 30 --gradient_checkpointing
echo "FINISH"