#!/bin/bash
#SBATCH --job-name=train6-exp2-fold4
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
--epochs 10 --batch_size 2 --lr 2e-5 --seed 42 --fold 4 --exp 2 \
--use_pretrained /gpfsnyu/scratch/yw3642/fb2/ckpt/pretrain0/exp4/pretrained_model.pt \
--adv_lr 1 --adv_eps 0.0005 --adv_after_epoch 1 --patience 30 --reduction none
echo "FINISH"