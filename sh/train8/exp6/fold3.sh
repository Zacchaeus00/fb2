#!/bin/bash
#SBATCH --job-name=train8-exp6-fold3
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
--epochs 10 --batch_size 4 --lr 1e-5 --lr_head 1e-3 --seed -1 --fold 3 --exp 6 \
--use_pretrained /gpfsnyu/scratch/yw3642/fb2/ckpt/pretrain0/exp16/pretrained_model.pt \
--adv_lr 1 --adv_eps 0.0003 --adv_after_epoch 1 --patience 30 --gradient_checkpointing --warmup_ratio 0.1
echo "FINISH"